...
const Reserve = () => {
  ...
  return (
    <section id="reservation-form">
      ...
      <div id="progress">
        {progress < 1 ? (
          <div className={progress < 1 ? "in-progress" : ""}>1</div>
        ) : (
        ...
        {progress > 1 ? (
          ...
          <div className={progress >= 1 ? "in-progress" : ""}>2</div>
        )}
        ...
        {progress > 2 ? (
          ...
          <div className={progress >= 2 ? "in-progress" : ""}>3</div>
        )}
        ...
        {progress > 3 ? (
          ...
          <div className={progress >= 3 ? "in-progress" : ""}>4</div>
        )}
      </div>
      {progress < 3 ? (
          ...
          <form action="" method="post">
            {progress === 0 ? (
              ...
              <>
                ...
                <div className="table-details">
                  <label htmlFor="seats">
                    seating option (indoor by default){" "}
        ...
        <Modal
          title={successful ? "Successful" : "Unsuccessful"}
          c1={
            successful
              ? "Your Reservation is  confirmed"
              : "Unfortunately, there aren't any tables available for your requested time at Little Lemon Restaurant."
          }
          c2={
            successful
              ? "A confirmation message has been sent to your email"
              : "Would you like to see alternative times or be added to a waitlist?"
          }
          c3={
            successful
              ? "Thanks for choosing Little Lemon Restaurant"
              : "We apologize for any inconvenience this may cause."
          }
          cta1={successful ? "New Reservation" : "See Altenative Time"}
          action={successful ? handleRefresh : null}
        />
      )}
    </section>
  );
