  ...
  return (
    <section id="testimonials">
        ...
        {Object.keys(user).map((key, index)=>{
            ...
            reviews ={
                index === 0? "Loved the dining experience! Will be back!" : index === 1? "Delicious food, impeccable service!" : index ===2? "Delightful culinary journey! Can't wait to return!" : index ===3? "Fantastic find! Exceeded expectations." : "Fantastic find! Exceeded expectations."
            }
            />
            )
        })}
